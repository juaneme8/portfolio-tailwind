...
const Header = (props: Props) => {
  return (
    <header className='md:min-h-[68vh] lg:min-h-screen min-h-screen w-3/4 md:pt-14 pt-8 text-center mx-auto relative'>
      ...
      <div className='absolute left-1/2 -translate-x-1/2 bg-gradient-to-b from-sky-400 to-transparent pt-8 px-4 rounded-t-full mt-8'>
